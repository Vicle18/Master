...
function createSimpleRelationshipPredicate({ matchPattern, listPredicateStr, childNode, innerOperation, }) {
    if (!innerOperation)
        return undefined;
    ...
    switch (listPredicateStr) {
        ...
        case "single": {
            ...
            return cypher_builder_1.default.single(childNode, patternComprehension, new cypher_builder_1.default.Literal(true));
        }
        case "not":
        case "none":
        case "any":
