...
function createInterfaceSubquery({ refNode, nodeVariable, field, resolveTree, context, parentNode, fullWithVars, }) {
    ...
    const direction = (0, get_relationship_direction_1.getCypherRelationshipDirection)(field, resolveTree.args);
    const pattern = new cypher_builder_1.default.Pattern(parentNode).related(relationshipRef).withDirection(direction).to(relatedNode);
