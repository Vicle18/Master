            ...
            <Form onSubmit={handleSubmit} >
              ...
              >
                ...
                <React.Fragment>
                  ...
                  {activeStep === 1 && (
                    <>
                      <Grid2 container spacing={2} sx={{ width: "80vw",
          height: "60vh",}}>
                        <Grid2
                          xs={3}
                          sx={{
              ...
              <DialogActions>
              {errors.name && <div><Chip label={errors.name} color="error" variant="outlined" /></div>}
              {errors.description && <div><Chip label={errors.description} color="error" variant="outlined" /></div>}
              {errors.host && <div><Chip label={errors.host} color="error" variant="outlined" /></div>}
              {ingressNodes.length < 1 && <div><Chip label={"At least one observable property is required"} color="error" variant="outlined" /></div>}
              {errors.port && <div><Chip label={errors.port} color="error" variant="outlined" /></div>}
              {errors.nodeId && <div><Chip label={errors.nodeId} color="error" variant="outlined" /></div>}

                <Button onClick={handlerClose}>Cancel</Button>
                <Button type="submit" disabled={!(isValid && ingressNodes.length > 0)}>
                  Create
                </Button>
              </DialogActions>
            </Form>
