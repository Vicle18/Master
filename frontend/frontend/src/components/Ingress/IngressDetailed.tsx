...
const DetailedView: React.FC<IDetailedViewProps> = ({
  ...
  const [selectedContainingElement, setSelectedParent] =
  ...
  const handleShowEdit = (data: any) => {
    ...
    if (connectionDetails.PROTOCOL == "MQTT") {
      ...
      initialValues.output =
        connectionDetails.PARAMETERS.OUTPUT
                  ...
                  <Grid2 container spacing={2}>
                    ...
                    >
                      ...
                      <Typography>
                        ...
                        {isJsonString(item.connectionDetails) &&
                          JSON.parse(item?.connectionDetails).PROTOCOL}
                      </Typography>
                      <Typography>
                        <Box component="span" fontWeight="bold">
                          Frequency:
                  ...
                  <Stack direction="row" spacing={1}>
                    ...
                    {PopupCreateEgress && (
                      <CreateEgressStepper
                        ...
                        setPopupEgress={setPopupCreateEgress}
